...
export default function Component14(props){
    ...
    return(<>
        ...
        <p> Box 는 div 와 같은 유형 , css 적용하는 방법 : 1. CSS파일 2. CSS객체 </p>
            <Box sx={{ display: 'flex', gap: 2 }} style={{ backgroundColor : 'wheat' }}>
                <Avatar />
                <Avatar>JG</Avatar>
                <Avatar alt="Remy Sharp" src="/static/images/avatar/1.jpg" />
            </Box>
            
        <h1> 6. 리스트 : https://mui.com/joy-ui/react-list/#collapsible-list </h1>
        <SideBar></SideBar>
    ...
    /* 
        리액트에서 CSS 적용하는 방법 
            ...
            2안) CSS객체 --> 컴포넌트(JSX)에서 객체유형으로 CSS 작성한다.   <컴포넌트명 style={{CSS카멜표기법}}
