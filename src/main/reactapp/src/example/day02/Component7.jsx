...
export default function Component7 ( props ){
    ...
    const countAdd = ()=>{ 
        // setXXX( 새로운 값 ); // 만일 값이 변경되었을때 해당 컴포넌트 재실행(재렌더링)
    ...
    const arrayAdd = ( ) => { // 주의할점은 useState는 수박을 관리 하는게 아니라 수박을 포함하는 [] 관리 
    ...
    const dataAdd = ( event ) =>{ 
        ...
        console.log( event );    
        console.log( event.target ); // onChange가 발동한 마크업 
