...
public class BookController {
    ...
    @PutMapping("1")
    public boolean cre1(){
        boolean result = bookService.cre1();
        return result;
    }
    ...
    @PutMapping("2")
    public boolean cre2(){
        boolean result = bookService.cre2();
        return result;
    }
    ...
    public List<Map<String, Object>> sel1(){
        List<Map<String, Object>> result = bookService.sel1();
        return result;
    }
    ...
    public List<Map<String, Object>> sel2(){
        List<Map<String, Object>> result = bookService.sel2();
        return result;
    }
